    ...
    def objective(self, trial):
        ...
        param = {
            "depth" : trial.suggest_int("depth",
                                        self.param_grid.depth_min,
                                        self.param_grid.depth_max,
                                        step=self.param_grid.depth_step),
            "min_child_samples" : trial.suggest_int("min_child_samples", 
                                                self.param_grid.min_child_samples_min,
                                                self.param_grid.min_child_samples_max,
                                                step=self.param_grid.min_child_samples_step),
            "eta" : trial.suggest_float("eta",
                                        self.param_grid.eta_min, 
                                        self.param_grid.eta_max, 
                                        log=True),
            "reg_lambda": trial.suggest_float("reg_lambda",
                                        self.param_grid.reg_lambda_min,
                                        self.param_grid.reg_lambda_max, 
                                        log=True),
            "colsample_bylevel": trial.suggest_float("colsample_bylevel",
                                                    self.param_grid.colsample_bylevel_min, 
                                                    self.param_grid.colsample_bylevel_max),
        } 
